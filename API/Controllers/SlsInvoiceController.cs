            ...
            using (var dbTransaction = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (res.ResponseState == true)
                    {
                        ...
                        string UpdQuery = " update Voucher_Receipt set TransferNo='" + TrnsNo + "' , InvoicesID='"+ ListInvoiceID + "' ,IsCash=" + Cash + ", Remark= N'("+ ListInvoiceID + ") ارقام الفواتير ' , CreatedBy='" + UserCode + "' , CreatedAt ='" + DateTime.Now.ToString() + "'  where ReceiptID = " + id + "";
