...
namespace AgingVend {
    ...
    var Details_Vendor: Array<IQ_GetVendor> = new Array<IQ_GetVendor>();
    var Details_Vendornew: Array<IQ_GetVendor> = new Array<IQ_GetVendor>();
    //------------------------------------------------------------
    ...
    ////////////////////////////////////Donia
    var AccountDetails: Array<IQ_GetVendor> = new Array<IQ_GetVendor>();
    ...
    function btnVnd_OnClick() {
        ...
        sys.FindKey(Modules.AgingVend, "btnVndSearch", "" + cond + "", () => {
    ...
    function getAccountById(custId: string, code: boolean) {
        ...
        Ajax.Callsync({
            ...
            success: (d) => {
                ...
                let result = d as BaseResponse;
                if (result.IsSuccess) {
                    AccountDetails = result.Response as Array<IQ_GetVendor>;
