$(document).ready(function () {
    GenDefVendorAdjust.InitalizeComponent();
});
var GenDefVendorAdjust;
(function (GenDefVendorAdjust) {
    ...
    var SysSession = GetSystemSession(Modules.GenDefVendorAdjust);
    ...
    function InitalizeComponent() {
        if (SysSession.CurrentEnvironment.ScreenLanguage == "ar") {
            document.getElementById('Screen_name').innerHTML = "أنواع تسويات الموردين";
        }
        else {
    ...
    GenDefVendorAdjust.InitalizeComponent = InitalizeComponent;
...
//# sourceMappingURL=GenDefVendorAdjust.js.map