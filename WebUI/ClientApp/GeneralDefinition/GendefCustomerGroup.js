$(document).ready(function () {
    GendefCustomerGroup.InitalizeComponent();
});
var GendefCustomerGroup;
(function (GendefCustomerGroup) {
    var AccountType = 1;
    var MSG_ID;
    ...
    var SysSession = GetSystemSession(Modules.GendefCustomerGroup);
    ...
    function InitalizeComponent() {
        if (SysSession.CurrentEnvironment.ScreenLanguage == "ar") {
            document.getElementById('Screen_name').innerHTML = "مجموعات العملاء";
        }
        else {
    ...
    GendefCustomerGroup.InitalizeComponent = InitalizeComponent;
...
//# sourceMappingURL=GendefCustomerGroup.js.map