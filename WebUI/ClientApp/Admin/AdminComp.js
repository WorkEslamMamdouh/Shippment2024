...
(function (AdminComp) {
    ...
    var chk_IsActive;
    var Txt_UserTimeZoneUTCDiff;
    var Txt_ServerTimeZoneUTCDiff;
    var Txt_SaudiNationID;
    var Txt_CurNameA;
    var Txt_CurNameE;
    var Txt_CurSmallNameA;
    var Txt_CurSmallNameE;
    var chk_WebCustomerWebsite;
    var chk_IsFreePurchaseReturn;
    var chk_IsFreeSalesReturn;
    var chk_InvoiceWithoutCust;
    var chk_ISCustVendorInGL;
    var chk_IsRetailCashInvoiceDefAuth;
    var chk_IsRetailCreditInvoiceDefAuth;
    var chk_IsProcessCashInvoiceDefAuth;
    var chk_IsProcessCreditInvoiceDefAuth;
    var chk_IsAccPeriodClose;
    var chk_IsInvPeriodClose;
    var chk_IsFasPeriodClose;
    var chk_IsAutoNoCustVendor;
    var chk_IsOprInvItemDiscount;
    var chk_IsOprInvMultiOper;
    var chk_IsRetailInvItemDiscount;
    var chk_IsRetailInvMultiStore;
    var IsNew = true;
    var comp_CODE = 0;
    var SystemCode;
    //------------------------------------------------------------
    ...
    function InitalizeControls() {
        ...
        //--------------------------------------------New--------------------------------------
        Txt_UserTimeZoneUTCDiff = document.getElementById("UserTimeZoneUTCDiff");
        Txt_ServerTimeZoneUTCDiff = document.getElementById("ServerTimeZoneUTCDiff");
        Txt_SaudiNationID = document.getElementById("SaudiNationID");
        Txt_CurNameA = document.getElementById("CurNameA");
        Txt_CurNameE = document.getElementById("CurNameE");
        Txt_CurSmallNameA = document.getElementById("CurSmallNameA");
        Txt_CurSmallNameE = document.getElementById("CurSmallNameE");
        chk_WebCustomerWebsite = document.getElementById("WebCustomerWebsite");
        chk_IsFreePurchaseReturn = document.getElementById("IsFreePurchaseReturn");
        chk_IsFreeSalesReturn = document.getElementById("IsFreeSalesReturn");
        chk_InvoiceWithoutCust = document.getElementById("InvoiceWithoutCust");
        chk_ISCustVendorInGL = document.getElementById("ISCustVendorInGL");
        chk_IsRetailCashInvoiceDefAuth = document.getElementById("IsRetailCashInvoiceDefAuth");
        chk_IsRetailCreditInvoiceDefAuth = document.getElementById("IsRetailCreditInvoiceDefAuth");
        chk_IsProcessCashInvoiceDefAuth = document.getElementById("IsProcessCashInvoiceDefAuth");
        chk_IsProcessCreditInvoiceDefAuth = document.getElementById("IsProcessCreditInvoiceDefAuth");
        chk_IsAccPeriodClose = document.getElementById("IsAccPeriodClose");
        chk_IsInvPeriodClose = document.getElementById("IsInvPeriodClose");
        chk_IsFasPeriodClose = document.getElementById("IsFasPeriodClose");
        chk_IsAutoNoCustVendor = document.getElementById("IsAutoNoCustVendor");
        chk_IsOprInvItemDiscount = document.getElementById("IsOprInvItemDiscount");
        chk_IsOprInvMultiOper = document.getElementById("IsOprInvMultiOper");
        chk_IsRetailInvItemDiscount = document.getElementById("IsRetailInvItemDiscount");
        chk_IsRetailInvMultiStore = document.getElementById("IsRetailInvMultiStore");
    }
