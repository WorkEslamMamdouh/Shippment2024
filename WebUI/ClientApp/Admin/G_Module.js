...
(function (G_Module) {
    ...
    var masterDetail = new G_MODULES();
    var Model = new G_MODULES();
    ...
    var GMODULES = new Array();
    var GetG_MODULES = new Array();
    ...
    G_Module.InitalizeComponent = InitalizeComponent;
    ...
    function Display() {
        debugger;
        GMODULES = GetDataTable('G_MODULES');
        debugger;
    ...
    function Disbly_BuildControls(cnt, Module) {
        debugger;
        ...
        var AVAILABLE = document.getElementById("AVAILABLE" + cnt);
        ...
        var PRINT = document.getElementById("PRINT" + cnt);
        ...
        var CUSTOM8 = document.getElementById("CUSTOM8" + cnt);
        ...
        var CUSTOM9 = document.getElementById("CUSTOM9" + cnt);
...
//# sourceMappingURL=G_Module.js.map