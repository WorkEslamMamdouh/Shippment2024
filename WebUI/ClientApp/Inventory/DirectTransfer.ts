...
namespace DirectTransfer {

    //System
    var sys: SystemTools = new SystemTools();
    var SysSession: SystemSession = GetSystemSession(Modules.Directtransfer);
    var compcode: Number;
    var Branch: Number;
    ...
    var HeaderWithDetailModel: IQ_DirectTransferWithDetail = new IQ_DirectTransferWithDetail();
    //Models
        ...
        if (SelectedTransferModel.length > 0) {
            ...
            Ajax.Callsync({
                ...
                success: (d) => {
                    let result = d as BaseResponse;
                    if (result.IsSuccess) {
                        HeaderWithDetailModel = result.Response as IQ_DirectTransferWithDetail;
