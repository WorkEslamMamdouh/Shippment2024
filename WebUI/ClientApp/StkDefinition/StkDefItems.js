...
(function (StkDefItems) {
    ...
    var SysSession = GetSystemSession(Modules.StkDefItems);
    ...
    function Assign() {
        ...
        for (var i = 0; i < CountGrid; i++) {
            ...
            if (StatusFlag == "u") {
                ...
                Model.DescA = $("#txtDescA" + i).val() == null ? $("#txtDescL" + i).val() : $("#txtDescA" + i).val();
                Model.DescL = $("#txtDescL" + i).val() == null ? $("#txtDescA" + i).val() : $("#txtDescL" + i).val();
                if ($("#Check_isActive" + i).is(':checked')) {
                    Model.IsActive = true;
                }
                else {
    ...
    function Details_All() {
        ...
        for (var i = 0; i < Details.length; i++) {
            ...
            if (Details[i].IsActive) {
                $("#Check_isActive" + i).attr('checked', 'true');
            }
            else
                $("#Check_isActive" + i).removeAttr('checked');
