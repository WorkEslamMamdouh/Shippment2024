...
(function (SlsTrSalesReturnNew) {
    ...
    var InvoiceItemsDetailsModelDelete = new Array();
    ...
    SlsTrSalesReturnNew.InitalizeComponent = InitalizeComponent;
    ...
    function btnInvoiceSearch_onclick() {
        debugger;
        var sys = new SystemTools();
        sys.FindKey(Modules.SlsTrReturn, "btnInvoiceSearch", "SlsInvSrc = " + SlsInvSrc + " and CompCode=" + compcode + "and BranchCode = " + BranchCode + " and TrType = 0  and Status = 1 ", function () {
    ...
    SlsTrSalesReturnNew.PrintReport = PrintReport;
...
})(SlsTrSalesReturnNew || (SlsTrSalesReturnNew = {}));
//# sourceMappingURL=SlsTrSalesReturnNew.js.map