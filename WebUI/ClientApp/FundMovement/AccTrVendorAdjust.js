...
var AccTrVendorAdjust;
(function (AccTrVendorAdjust) {
    var IQ_TrType = 1;
    var AccType = 2;
    var TrType = 1;
    var custId = 0;
    ...
    var SysSession = GetSystemSession(Modules.AccTrVendorAdjust);
    //txt_ID_CustmNew
    ...
    function InitalizeControls() {
        ...
        btnVndH = document.getElementById("btnVndH");
        txt_VndCodeH = document.getElementById("txt_VndCodeH");
        txt_VndNameH = document.getElementById("txt_VndNameH");
    }
    ...
    function DisplayData(Selecteditem) {
        ...
        var custid = Selecteditem[0].VendorId.toString();
                    ...
                    if (result.IsSuccess) {
                        ...
                        for (var i = 0; i < Details.length; i++) {
                            ...
                            if (Details[i].IsDebit) {
                                ...
                                Details[i].IsDebitNew = (lang == "ar" ? "دأئن" : "Creditor");
                            }
    ...
    AccTrVendorAdjust.PrintReport = PrintReport;
    ...
    function btnVndH_OnClick() {
        sys.FindKey(Modules.AccTrVendorAdjust, "btnVndSearch", "CompCode= " + compcode + "and IsCreditVendor = 1", function () {
...
//# sourceMappingURL=AccTrVendorAdjust.js.map