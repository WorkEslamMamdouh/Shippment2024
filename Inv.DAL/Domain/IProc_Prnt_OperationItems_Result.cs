...
namespace Inv.DAL.Domain
{
    ...
    public partial class IProc_Prnt_OperationItems_Result
    {
        ...
        public Nullable<decimal> IT_EstSalesPrice { get; set; }
        public Nullable<decimal> IT_MinSalesPrice { get; set; }
        public Nullable<decimal> IT_CostPrice { get; set; }
